...
Type-ahead product-name completions served by `GET /autocomplete`, backed by a `search_as_you_type`
field and a short-TTL, fail-open Redis cache keyed by the normalized prefix.
